...
class _DocumentosKycEmisionScreenState
  ...
  /// Y ese campo específico ya tiene una URL subida.
  bool _campoBloqueado(String? urlActual) {
    if (_expediente?.validadoPorAnalista != true) return false;
  ...
  @override
  Widget build(BuildContext context) {
    // Solo mostramos el banner de "validado" si realmente está validado.
    // El usuario SIEMPRE puede subir/reemplazar documentos a menos que ese
    // campo específico ya esté validado.
    final todoValidado = _expediente?.validadoPorAnalista == true;
          ...
          : SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Siempre mostramos el botón a menos que TODO esté validado
                  // y no haya cambios pendientes
                  if (!todoValidado ||
                      _anversoUrl == null ||
                      _reversoUrl == null ||
                      _domicilioUrl == null)
                    ...
                    // Todos validados: mostrar info y botón para actualizar de todas formas
                    Column(
                      children: [
                        Container(
                          padding: const EdgeInsets.all(12),
                          ...
                          child: const Text(
                            '✓ Todos tus documentos han sido validados por el analista.',
